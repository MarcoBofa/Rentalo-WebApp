        ...
        <div className="flex h-screen">
            ...
            <div className="w-1/2 p-10 flex flex-col items-center justify-center relative bg-black">
                <div className="absolute inset-0">
                    <svg className="w-full h-full" viewBox="0 0 100 100" preserveAspectRatio="none">
                        <defs>
                            <linearGradient id="greyGradient" x1="100%" y1="100%" x2="0%" y2="100%">
            ...
            <div className="w-1/2 bg-white p-10 flex items-center justify-center">
                <div className="w-2/3">
                    ...
                    <h2 className="text-3xl font-bold mb-6">Crea il tuo account - Azienda</h2>
                    <form>
                        <div className="mb-4 flex space-x-4">
                            ...
                            <div className="w-1/2">
                                <InputField label="P.IVA" type="text" />
                            </div>
                        </div>
                        <div className="mb-4">
