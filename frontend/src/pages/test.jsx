        ...
        <div className="min-h-screen flex items-center justify-center bg-gradient-to-r from-orange-600 to-gray-700 relative">
            ...
            <div className="w-full max-w-6xl p-8 bg-white rounded-lg shadow-lg z-10 relative">
                <div className="text-center mb-20">
                    <h1 className="text-5xl font-bold text-gray-800 mb-4">Noleggia Attrezzatura e Macchinari</h1>
                    <p className="text-xl text-gray-600 mb-10">Seleziona il tipo di account per continuare la regisrazione</p>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    ...
                    <div className="bg-gray-100 p-8 rounded-lg shadow-lg text-center">
                        ...
                        <button className="bg-orange-600 text-white px-6 py-3 rounded-lg shadow-lg hover:bg-gray-900">
                            Registrati
                        </button>
                    </div>
                    ...
                    {/* Impresa */}
                    <div className="bg-gray-100 p-8 rounded-lg shadow-lg text-center">
                        <h2 className="text-3xl font-semibold mb-6 text-gray-800">Impresa</h2>
                        <p className="text-lg mb-6 text-gray-700">
                            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Proin suscipit nisl vitae augue.
                        </p>
                        <button className="bg-orange-600 text-white px-6 py-3 rounded-lg shadow-lg hover:bg-gray-900">
                ...
                <div className="mt-12 text-center">
                    <span className="text-blue-800 hover:underline cursor-pointer">
                        Già Registrato? Esegui il login.
                    </span>
                </div>
            </div>
        </div>
